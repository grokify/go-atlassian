...
// Batch transitions
options := jira.TransitionOptionSet{
    Options: []jira.TransitionOption{
...
categories := jira.StatusCategories{...}
...
reqBody := jira.IssuePatchRequestBody{
    Fields: map[string]jira.IssuePatchRequestBodyField{
        "priority": {Value: "High"},
    },
}
...
|------|-------------|--------|
| Added | `IssueService.DoTransitions()` | [`350db95`](https://github.com/grokify/go-atlassian/commit/350db95) |
| Added | `IssueService.DoTransitionWithNameAndPayload()` | [`48b51bc`](https://github.com/grokify/go-atlassian/commit/48b51bc) |
| Added | `IssueService.GetTransitions()` | [`f066b2d`](https://github.com/grokify/go-atlassian/commit/f066b2d) |
| Added | `Transition{}`, `Transitions{}` types | [`59e1796`](https://github.com/grokify/go-atlassian/commit/59e1796) |
| Added | `IssuesSet.FilterByStatusCategory()` | [`7640a46`](https://github.com/grokify/go-atlassian/commit/7640a46) |
| Added | `IssuesSet.HistogramByStatus()`, `HistogramByStatusCategory()` | [`f7e0fdf`](https://github.com/grokify/go-atlassian/commit/f7e0fdf) |
| Added | `IssuesSet.HistogramByCustomField()` | [`af1d8ab`](https://github.com/grokify/go-atlassian/commit/af1d8ab) |
| Added | `IssueService.IssuesPatch()`, `IssuesPatchAddLabel()` | [`9944a42`](https://github.com/grokify/go-atlassian/commit/9944a42) |
| Added | `IssueService.SearchIssuesSetWithFileCache()` | [`38dd2f3`](https://github.com/grokify/go-atlassian/commit/38dd2f3) |
| Added | `IssuesSet.FilterByKeys()`, filter methods | [`f6a59f9`](https://github.com/grokify/go-atlassian/commit/f6a59f9) |
| Added | `IssueMore.Description()` | [`edf1a04`](https://github.com/grokify/go-atlassian/commit/edf1a04) |
| Added | `IssuesSet.Summaries()` | [`6bcf571`](https://github.com/grokify/go-atlassian/commit/6bcf571) |
| Added | `IssueMore.ResolutionTime()` | [`adc5a25`](https://github.com/grokify/go-atlassian/commit/adc5a25) |
| Added | `JQL.SummaryLike`, `TextLike`, etc. | [`7ba5f3a`](https://github.com/grokify/go-atlassian/commit/7ba5f3a) |
| Added | `StatusCategories.StatusesForCategories()` | [`46ea60f`](https://github.com/grokify/go-atlassian/commit/46ea60f) |
| Added | `IssuesSets.Histogram()`, `BarChartsText()` | [`d77c98a`](https://github.com/grokify/go-atlassian/commit/d77c98a) |
| Changed | Externalized `IssueMore.Issue` | [`8f21c6a`](https://github.com/grokify/go-atlassian/commit/8f21c6a) |
| Changed | Renamed `IssuesSet.Items` | [`72f52c2`](https://github.com/grokify/go-atlassian/commit/72f52c2) |
