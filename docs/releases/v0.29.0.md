...
- **Package refactoring** for cleaner imports: `jirarest` → `jira`, `jiraxml` → `xml`, `jiraweb` → `web`
- **MkDocs documentation site** with Material theme at [grokify.github.io/go-atlassian](https://grokify.github.io/go-atlassian/)
...
| Before | After |
|--------|-------|
| `github.com/grokify/gojira/jirarest` | `github.com/grokify/go-atlassian/jira` |
| `github.com/grokify/gojira/jiraxml` | `github.com/grokify/go-atlassian/xml` |
| `github.com/grokify/gojira/jiraweb` | `github.com/grokify/go-atlassian/web` |
...
Visit: [grokify.github.io/go-atlassian](https://grokify.github.io/go-atlassian/)

## Tests

Added comprehensive tests for the `jira` package:
...
|------|-------------|--------|
| Breaking | Package imports changed | [`5fcf3ed`](https://github.com/grokify/go-atlassian/commit/5fcf3ed) |
| Added | `gojira` CLI | [`10b40a2`](https://github.com/grokify/go-atlassian/commit/10b40a2) |
| Added | `stats` command | [`a910dee`](https://github.com/grokify/go-atlassian/commit/a910dee) |
| Added | `patch`, `export`, `fields` commands | [`910e502`](https://github.com/grokify/go-atlassian/commit/910e502) |
| Docs | MkDocs documentation site | [`c9b2902`](https://github.com/grokify/go-atlassian/commit/c9b2902) |
| Docs | README updates | [`5b7c648`](https://github.com/grokify/go-atlassian/commit/5b7c648) |
| Tests | Unit and integration tests | [`12bf737`](https://github.com/grokify/go-atlassian/commit/12bf737) |
